...
export const createRtcIdTokenOnRequest = functions.https.onRequest(async (request, response) => {
  ...
  functions.logger.info("end : createRequestDataObject", { structuredData: true });
