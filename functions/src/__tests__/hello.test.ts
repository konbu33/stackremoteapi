...
import { helloWorldSecureOnRequest } from '../index';
...
// 明示的に型を指定し、変変定義する
const mockVerifyFirebaseAuthIdToken: jest.Mock = (verifyFirebaseAuthIdTokenOnRequest as jest.Mock);

// テスト対象の関関とFirebaseのProjectとを紐付けるために、testConfigを読み込み。
import { testConfig } from './setup';
import { helloWorldSecureOnCall } from '../index';
